          ...
          children: [
            Center(
              child: ModuleCard(
                ...
                title: '',
                onTap: () {
                  Navigator.pushNamed(context, '/searchClientScreen');
                },
              ),
            ),
            _ProductDetails(
            ...
            // const Positioned(top: 0, right: 0, child: _PriceTag(2)),
            if (title.isEmpty)
...
class _PriceTag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: themeDynamic.getThemeIsMedi()
              ? AppTheme.backgroundColorMedi
              : const Color.fromARGB(255, 75, 69, 70),
          borderRadius: const BorderRadius.only(
